...
@Component({
  ...
  standalone: true,
  template: `
    <section class="fade-in-up fade-delay-2 space-y-5">
      <article class="section-card border-amber-300/25 p-5 sm:p-8">
        <p class="section-kicker">Solução</p>
        <h2 class="section-title">A real é simples</h2>
        <p class="mt-4 text-[15px] leading-relaxed text-zinc-300 sm:text-lg">
          Eu ajusto seu Instagram pra transformar quem vê em cliente te chamando
          no WhatsApp pra agendar.
        </p>
        <p class="mt-3 text-[15px] leading-relaxed text-zinc-300 sm:text-lg">
      ...
      <div class="grid gap-5 lg:grid-cols-[1fr_1fr]">
        ...
        <article class="section-card border-amber-300/25 p-5 sm:p-8">
          ...
          <div class="mt-4 rounded-xl border border-white/12 bg-zinc-950 p-4">
          ...
          <div class="mt-4 grid gap-3 sm:grid-cols-2">
            <div class="overflow-hidden rounded-xl border border-red-400/30 bg-red-500/12">
              <img
            ...
            <div class="overflow-hidden rounded-xl border border-emerald-400/30 bg-emerald-500/12">
              <img
